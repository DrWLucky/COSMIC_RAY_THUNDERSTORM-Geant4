...
//
//    Efield_State current_efield_status = ON;
//    Efield_State initial_efield_status = ON;
//
...
//
//    const bool CR_GENRATOR_write_output_FOR_TEST = false; // test or not the CR particle generator (i.e. output the list of
//    // particles)
...
//
//    const bool USE_WALL_TIME_LIMIT_FOR_EVENT = true;
//

...
AnalysisManager *
AnalysisManager::getInstance() // singleton lazy initialization
{
    if (instance == nullptr)
...
AnalysisManager::AnalysisManager() // constructor
{
    ...
    asciiFileName1 = first_part + std::to_string(Settings::RANDOM_SEED) + rec_alt_part + potential_str + efield_alt_str
        + efield_length_str + ".out";
...
G4int
AnalysisManager::NB_OUTPUT() const
{
    return NB_OUTPUT_;
}
...
// ....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void
AnalysisManager::write_output_file_endOf_program()
{
...
G4double
AnalysisManager::interpolate(std::vector<G4double> &xData, std::vector<G4double> &yData, G4double x, bool extrapolate)
{
...
G4double
AnalysisManager::get_scale(const G4double alt)
{
...
void
AnalysisManager::fill_histogram(const G4int idx_part,
                                const G4int idx_alt,
...
void
AnalysisManager::fill_histogram_ener(const G4int idx_part, const G4int idx_alt, const G4double &value)
{
...
void
AnalysisManager::fill_histogram_momX(const G4int idx_part, const G4int idx_alt, const G4double &value)
{
...
void
AnalysisManager::fill_histogram_momY(const G4int idx_part, const G4int idx_alt, const G4double &value)
{
...
void
AnalysisManager::fill_histogram_momZ(const G4int idx_part, const G4int idx_alt, const G4double &value)
{
...
void
AnalysisManager::check_if_should_use_stacking_action()
{
    ...
    Settings::DELTA_T = 27.3 / (EFIELD_VAL_KV_PER_M * atmos_scale - 277.0)
        * atmos_scale; // in micro second for the stacking action that set up the fake time oriented
...
std::vector<double>
AnalysisManager::get_MOM_grid()
{
    std::vector<double> mom_grid{-1.0000,
                                 -0.9843,
                                 -0.9685,
                                 -0.9528,
                                 -0.9370,
